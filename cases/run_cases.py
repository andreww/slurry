...
# Lists of parameters - by default, I suppose we could take these from
# command line
i0 = [1.0E-7, 1.0E-8, 1.0E-9, 1.0E-10, 1.0E-11]
dl_mu_pairs = [(1.0E-11, 2.0E-6), (1.0E-11, 3.0E-5), (1.0E-11, 6.0E-8), 
               (1.0E-12, 2.0E-6), (1.0E-9, 2.0E-6)]
...
def replace_params(infile, outfile, i0, dl, mu):
    ...
    dat = dat.replace("chemical_diffusivity : 1.0e-9", 
                      f"chemical_diffusivity : {dl:E}")
    dat = dat.replace("kinematic_viscosity : 2.0e-6", 
                      f"kinematic_viscosity : {mu:E}")
    ...
    for myi0 in i0:
        for mydl_mu in dl_mu_pairs:
            ...
            if not target_path.exists():
                ...
                replace_params(target_path/"parameters.yaml", 
                               target_path/"parameters.yaml", myi0, dl, mu)
